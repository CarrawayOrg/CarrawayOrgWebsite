export default function Footer() {
  return (
    <footer className="text-gray-200">
      <div className="max-w-5xl xl:max-w-5xl mx-auto divide-y divide-gray-900 ">
        <ul className="text-sm font-medium sm:pb-3 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-3">
        ...
        <div className="flex flex-col-reverse justify-between pt-5 pb-4 border-t lg:flex-row bg-top border-black">
          ...
          <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
            ...
            >
              Copyright © 2022 Carraway Organization
            </a>
            <a
              href="/"
              className="text-md text-gray-200 hover:text-white transition-colors duration-300 hover:text-deep-purple-accent-400 font-semibold tracking-tight"
